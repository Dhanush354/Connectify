    ...
    return(
        ...
        border-gray-200 rounded-md">
            ...
            <div className="flex mt-4 gap-2">
                {/*Follow Button*/}
                <button onClick={handleFollow} disabled={currentUser?.following.includes(user._id)} className="w-full py-2 rounded-md flex items-center justify-center gap-2
                ...
                cursor-pointer active:scale-95 transition">
                    {
                        ...
                        <MessageCircle className="w-5 h-5 group-hover:scale-105"/> : <Plus className="w-5 h-5 group-hover:scale-105 transition"/>
                    }
                </button>
            </div>
        </div>
