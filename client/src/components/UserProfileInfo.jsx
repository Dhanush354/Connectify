    ...
    return(
        <div className="relative py-4 px-6 md:px-8 bg-white">
            <div className="flex flex-col md:flex-row  items-start gap-6">
                <div className="w-32 h-32 border-4 border-white rounded-full shadow-lg absolute -top-16">
                ...
                <div className="w-full pt-16 md:pt-0 md:pl-36">
                    ...
                    <div className="flex items-center gap-6 bordert border-gray-200 pt-4">
                        <div>
