...
const ProfileModel =({setShowEdit})=>{
    ...
    return(
        <div className="fixed top-0 bottom-0 left-0 right-0 z-110 h-screen overflow-y-scroll 
        bg-black/50">
            <div className="max-w-2xl sm:py-6 mx-auto">
                <div className="bg-white rounded-lg shadow p-6">
                    <h1 className="text-2xl font-bold text-gray-900 text-gray-900 mb-6">Edit Profile</h1>
                    <form className="space-y-4" onSubmit={e=> toast.promise(handleSaveProfile(e),
                        ...
                        <div className="flex flex-col items-start gap-3">
                            ...
                            text-gray-700 mb-1">
                                ...
                                <div className="group/profile relative">
                                    ...
                                    <div className="absolute hidden group-hover/profile:flex top-0 left-0 right-0 bottom-0 bg-black/20 rounded-full
                        ...
                        <div className="flex flex-col items-start gap-3">
                            ...
                            text-gray-700 mb-1">
                                Cover Photo
                                <input hidden type="file" accept="image/*" id="cover_photo" className="w-full p-3 
                                border border-gray-200 rounded-lg" onChange={(e)=>setEditForm({...editForm,cover_photo:e.target.files[0]})} />
                        ...
                        <div>
                            ...
                            placeholder="please enter bio" onChange={(e)=>setEditForm({...editForm,bio:e.target.value})} value={editForm.bio} />
                        </div>
                        ...
                        <div>
                            ...
                            <textarea  type="text" className="w-full p-3 border border-gray-200 rounded-lg"
